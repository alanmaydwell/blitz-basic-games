...
Text 0,h7,"(F6) Closed screen boundary ? " +a$
Color 200,100,255
...
If KeyDown(64) And closed=True Then closed=False:a$="OFF": Delay 200
If KeyDown(64) And closed=False Then closed=True:a$="ON":Delay 200
Flip
Until KeyDown(57) Or KeyDown(1)
