...
Cls
update_bem()
If player_status=0 Then Oval player_x-25,player_y-25,50,50
update_ship
update_bullets
...
If (level Mod 4=3)  Then bem(i)\tp=2 Else bem(i)\tp=1; Sets BEM type. (Note 0 = dead)
...
If bem(i)\tp<>0 Then 
	...
	If bem(i)\tp=1 Then im_bem=im_bem1 Else im_bem=im_bem2
