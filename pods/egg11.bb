...
Global sn_moon=LoadSound("data\mooner.mp3")
...
;Play looping music
LoopSound sn_moon
chn_moon=PlaySound(sn_moon)

Local x,y,dx,dy,countdown
x=midx
y=midy
countdown=0
...
;Set new velocities if countdown reaches 0
If countdown<=0
Repeat
dx=Rnd(-8,8)
dy=Rnd(-8,8)
...
Color 255,255,255
Text midx,H(3),"PRESS SPACE TO START",1,1
Flip 
