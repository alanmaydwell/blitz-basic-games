...
If bem\im=5 Then DrawImage im_swarm,bem\x,bem\y,1
...
If bem\mt=3 Then; plunger
bem\yo=bem\yo+bem\dy
If bem\y>height Then Delete bem 
End If 
...
;detects collision between upward moving laser and baddie
For bem.blob = Each blob
...
If bem\im=3 Then 
spawn(bem\x+30,bem\y-40,0,0,0,5,2)
spawn(bem\x-30,bem\y-40,0,0,0,5,2)
spawn(bem\x+30,bem\y+40,0,0,0,5,2)
spawn(bem\x-30,bem\y+40,0,0,0,5,2)
PlaySound(snd_swarm) 
