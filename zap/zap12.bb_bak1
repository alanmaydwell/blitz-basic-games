...
spawn(midx+(loop*100),H(7),7,5,180,1,1)
Next
...
Function set_text()
temp_c=0
words.stext=New stext:words\y=H(13):words\A$="CONTROLLS"
words.stext=New stext:words\y=H(14):words\A$="Z - Left"
words.stext=New stext:words\y=H(15):words\A$="X - Right"
words.stext=New stext:words\y=H(16):words\A$="; - Up"
words.stext=New stext:words\y=H(17):words\A$=". - Down"
words.stext=New stext:words\y=H(18):words\A$="Return - Fire"
words.stext=New stext:words\y=H(19):words\A$="Or use a joystick"
words.stext=New stext:words\y=H(20):words\A$="Esc - Quit"
...
words\y=words\y-2
If words\y<=0 Then words\y=height 
Next
